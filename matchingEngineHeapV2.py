...
class MatchingEngine:
    ...
    def processOrder(self,order):
            ...
            orderbook.add(order)
            if (order.side == 'buy'):
                print(f"Buy order {order.order_id,order.instrument} is added to orderbook")
                
            else:
                print(f"Sale order {order.order_id,order.instrument} is added to orderbook")
        ...
        # Buy order crossed the spread.
                ...
                print(f"Order {order.order_id,order.instrument} matched with sell order {orderbook.bestAsk().order_id}")
        ...
        # Sell order crossed the spread.
                ...
                print(f"Matched with buy order {orderbook.bestBid().order_id}")
            else:
    ...
    def acknowledgeOrder(self, matchedOrder):
        ...
        print(f"Order acknowledgmenet for {matchedOrder.order_id,matchedOrder.instrument}")
